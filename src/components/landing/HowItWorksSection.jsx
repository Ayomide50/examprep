...
const steps = [
  ...
  },
  {
    ...
    description: "Enter your activation code in the platform to unlock full access to all 7000+ questions.",
            ...
            <StaggerItem key={i}>
              <div className="bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg transition-all duration-300 group h-full">
                <div className="flex items-start gap-4">
                  <div className={`w-11 h-11 rounded-xl ${step.iconBg} flex items-center justify-center shrink-0 md:group-hover:scale-110 md:transition-transform`}>
