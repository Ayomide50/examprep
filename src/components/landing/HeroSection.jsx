...
const stats = [
  { value: "7000+", label: "Practice Questions", sub: "Across all 35+ courses", icon: FileText, color: "text-blue-600 bg-blue-50" },
  { value: "35+", label: "Courses Available", icon: BookOpen, color: "text-purple-600 bg-purple-50" },
